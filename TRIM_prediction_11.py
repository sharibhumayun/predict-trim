...
def main():
    ...
    Communication = st.sidebar.text_input('Communication',0.0,100.0,50.0)
    Proposition = st.sidebar.text_input('Proposition',0.0,100.0,50.0)
    Sales_Experience = st.sidebar.text_input('Sales Experience',0.0,100.0,50.0)
    Opt_inout = st.sidebar.text_input('Opt in out',0.0,100.0,50.0)
    Network = st.sidebar.text_input('Network',0.0,100.0,50.0)
    Customer_Support = st.sidebar.text_input('Customer Support',0.0,100.0,50.0)
    Billing_Payment = st.sidebar.text_input('Billing & Payment',0.0,100.0,50.0)
